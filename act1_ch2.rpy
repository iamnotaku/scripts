...
#    show natsuki 2k at t11 zorder 1
    ...
    kt "[player]?"
    mc "{i}Ehi Kotonoha, abbiamo finito qui. Potete venire.{/i}"
    kt "Com'è andata?"
    mc "{i}Beh, poteva andare peggio.{/i}"
    kt "Huh? Cosa vorrebbe dire questo?"
    mc "{i}Sayori e Yuri hanno capito Monika, però non sono convinte del rimorso di Monika.{/i}"
    kt "E Natsuki?"
    mc "{i}Stanotte verrò al tuo hotel così potremo parlare.{/i}"
    kt "O-{w=0.5}oh... {w=0.5}Sei sicuro?"
    mc "{i}Certo, perchè no?{/i}"
    kt "N-{w=0.5}no! Non intendevo in quel senso, solo che..."
    mc "{i}Okay... Venite qui.{/i}"
    kt "Mhm~"
    "Ahhh, sono stata fortunata questa volta! Mio si sta comportando in modo strano verso di me."
    "Penso di poter evitare la sua domanda questa volta."
    "COmunque, rimetto il telefono nella mia borsetta e chiamo Mio."
    show mio 1a at t11 zorder 1
    kt "Mio, è ora di andare!"
    mi 3e "Okay Kotonoha, andiamo~"
    mi "Mi stavo quasi dimenticando! Non pensare di poter sfuggire alla mia domanda!~"
    stop music fadeout 2.0
    kt "Uh... S-{w=0.5}sì, credo di non aver scelta..."
    mi 1x "Esatto! Dai, andiamo."
    show mio at thide
    hide mio
    "Senza dire altro, Mio si volta verso l'edificio."
    "Beh... C'era qualcosa... Quella domanda che Mio mi ha fatto è un po' dubbia in realtà..."
    "Nel senso, presumibilmente lei non sa niente di questo mondo e non dovrebbe ricordare chi io sia."
    window hide(None)
    window auto
    pause 2.0
    "O... Se lo ricorda?"
    scene bg mc_lr
    with dissolve_scene_full
    "E' passata un'ora da quand'è finita scuola. Da allora sono stata pronta per l'incontro di oggi con Monika."
    "Non vorrei sembrare un senzatetto dopotutto."        #I wouldn't want to look like a homeless bum after all."
    "Stavo pensando anche a Kotonoha oggi... Ogni volta che le parlo, si agita e inizia a balbettare."
    "Quasi come se provasse qualcosa per me, ma... Perchè dovrebbe provare qualcosa per me? E' possibile? E cioè avere una cotta per qualcuno che non conosci per niente."
    "Non lo so... Ma devo farle capire che io amo Monika. Devo stare attento però, non vorrei mai che si suicidasse..."
    "Cioè, Kotonoha è davvero carina ma non è il mio tipo. Senza menzionare il fatto che io l'abbia appena incontrata, quindi... Uscire con lei non sarebbe per niente giusto."
    "Glielo dirò presto."
    play sound "<from 2.00>mod_assets/theme/door.ogg"
    window hide(None)
    window auto
    pause 2.0
    "Sento bussare alla porta. Monika deve essere già qui."
    scene black with wipeleft
    scene bg mc_hw with wipeleft
    mc "Sì?"    
    m "Sono io [player]~"
    ...
    m "Ciao [player]~"
    mc "Hey Monika! Ti sei presa il tuo tempo, vero?"
    show monika 1bk at h11 zorder 1
    m "Ahaha!"
    m 4bk "Beh, dovevo prepararmi dopotutto. E' meglio di essere venuta qui con la mia uniforme, no?"
    mc "Heh... Già, me l'hai fatta. Quindi, dove siamo diretti?"
    m 2bc "Hm..."
    m 2be "Non lo so. Pensavo pianificato qualcosa."
    mc "Heh... Non proprio."
    m 2bb "Oh, ce l'ho! E se seguissimo la corrente?"
    mc "Hm... Sei sicuro?"
    m 1bb "Mhm~"
    mc "Va bene allora... Conosci qualche bar qui vicino? Conosco a malapena il mio vicinato."
    m 1bj "Ahaha!~"
    extend 1ba " Certo, [player]. C'è un ottimo bar in città!"
    mc "Ti seguo."
    "Con questo entrambi ci dirigiamo verso il bar di cui Monika stava parlando."
    play sound closet_open
    scene black with wipeleft
    scene bg house with wipeleft
    play sound closet_close
    "Una volta fuori Monika indica verso la direzione in cui dobbiamo andare, e sembra sia sulla stessa strada dove si trova Kotonoha."
    scene black with wipeleft
    scene bg street with wipeleft
    "Dio... Parlandone, sono ancora preoccupato per Kotonoha... Non posso fare a meno di pensare a cosa lei abbia passato... Se voglio impegnarmi di più per Kotonoha, ho bisogno di sapere cosa le sta succedendo."
    "Proverò a raggiungerla appena avrò finito di passare del tempo con Monika."
    if persistent.kt_choice1 == 1:
      "Sai, devo essere sicuro che stia bene. Cioè, il modo in cui si è comportata stamattina era un po' strano. Quel \"problema\" che ha menzionato non è qualcosa a cui posso semplicemente credere."

      "Ho bisogno di mostrarle che mi importa davvero di lei, per questo ho bisogno di assicurarmi che stia bene."
    else:
      "Non l'ho ancora ringraziata per tutto quello che ha fatto oggi, e sono abbastanza sicuro che farlo potrebbe farla molto felice."
      "Voglio davvero farle sapere che mi piace e che le sono davvero grato per tutto l'aiuto che mi ha datto fino ad adesso."
    show monika 1bg at t11 zorder 1
    m "Um... [player], tutto apposto?"
    mc "Ah--"
    mc "C-certo, perchè?"
    m 2bg "Sembri un po' stressato... C'è qualcosa che ti sta stressando così tanto?"
    mc "No no, stavo solo pensando alla poesia che dovrò scrivere per l'incontro di domani."
    m 2bc "Oh!"
    extend 3bb "Ti è già venuto qualcosa in mente allora?"
    mc "Per niente... Ci sto ancora pensando, non è che io sia un grande scrittore dopotutto."
    m 1bb "Beh, sono sicura che ti verrà proprio una bella poesia alla fine. "
    extend 1ba "L'unica cosa di cui hai bisogno è di un po' di pratica!"
    mc "Pensi?"
    m 3bk "Ovviamente! Tutti noi abbiamo talento per qualcosa, però la pratica è necessaria."
    mc "Heh... Giusto, credo tu abbia ragione. E tu invece? Hai già un'idea per la tua poesia?"
    m 1bb "Sì, ma non te lo dirò~ Ahaha!"
    mc "Capisco... Beh, Sono una persona paziente. Più o meno."
    show monika 3bb at h11 zorder 1
    m "Non è l'hotel di Kotonoha quello?"
    scene black with wipeleft
    scene bg st with wipeleft
    "Monika punta in direzione dell'hotel di Kotonoha. E' certamente un hotel molto grande, e neanche molto economico."
    "Monika mi chiama, tirandomi la manica mentre mi fa un dolce sorriso."
    show monika 2bl at t11 zorder 1
    m "Sai cosa? Voglio andare a visitarla e tirarla su dopo tutte le cose che le hai dovuto far passare."
    mc "H-hey, ho detto che mi sono scusato! Sperando che lo abbia capito..."
    m "Ahaha!~ "
    extend 3bb "Beh, credo che Kotonoha in realtà sia una ragazza stupenda. Sono sicura che troverà un ragazzo che sappia apprezzarla e che la ami."
    mc "Già, è davvero una persona splendida. Sono anche sorpreso di quanto vi conosca bene tutti."
    mc "Kotonoha è una ragazza misteriosa, vero?"
    m 2bc "Eh?"
    extend 1bd " Di cosa stai parlando?"
    mc "Um... Niente. Sto solo pensando a della roba assurda."
    mc "Comunque, dove si trova il bar?"
    m 3bb "Laggiù."
    scene black with wipeleft
    scene bg cafe2 with wipeleft
    "Come ha detto Monika, questo bar sembra davvero bello essendo accanto all'hotel di Kotonoha."
    "Wow... Sono davvero sorpreso. Non sapevo neanche che questo bar esistesse. Dovrei davvero andare fuori più spesso."
    "Monika è in piedi di fronte a me mentre sorride."
    show monika 1ba at t11 zorder 1
    m 1ba "Quindi, cosa ne pensi, [player]?"
    mc "Beh... Sembra bello da fuori."
    m 1be "Oh..."
    extend 2bb "Beh, questo è davvero un ottimo bar! Ti assicuro che lo adorerai."
    mc "Okay, allora cosa stiamo aspettando? Andiamo dentro!"
    "Senza dire nient'altro Monika annuisce e entrambi ci avviamo verso il bar."
    show monika 1bb at h11 zorder 1
    m "Seguimi~"
    scene black with wipeleft
    scene bg cafe_inside with wipeleft
    "Come entriamo, il profumo di caffè riempie completamente la sala dandole un'ambiente più maturo. Mi sento un po' strano però..."
    show monika 1bb at t11 zorder 1
    m "Beh?"
    mc "Woah, questo certo che è un gran posto! E il profumo di caffè è anche meglio."
    m 2bb "Aspetta solo di aver assaggiato il caffè!"
    "Monika si dirige verso il commesso e lo saluta allegramente."
    m "Salve!"
    $ n_name = "Commesso"
    n "Benvenuta signorina, posso prendere i vostri ordini?"
    m "Certo, potrei avere un americano?"
    n "Okay! E il ragazzo cosa desidera?"
    mc "Hm... Beh, in realtà non sono un gran bevitore di caffè, quindi non sono sicuro di cosa ordinare."
    m 3bb "Che ne pensi di un caffè-latte?"
    mc "Non sono neanche un bambino..."
    "Il commesso mentre mi sta guardando decide di darmi un suggerimento."
    n "Che ne pensi di un cappuccino? Non è così forte come quello che ha ordinato la signorina!"
    mc "Hm... Okay, prenderò quello."
    n "Bene! Sono 551¥."
    "Come il commesso prende i nostri ordini, Monika prende un po' di soldi fuori dal suo borsellino."
    mc "Aspetta, Monika..."
    m 2bc "Hm?"
    "Non è giusto se pagasse per i caffè, mi sentirei male se lo facesse."
    "Ma non è neanche giusto se pagassi tutto io, no?"
    menu:
      mc "Beh..."
      "Pago io per tutto.":
        $ pay_everything = True
    ...
    if pay_everything:
      "No, sono io quello che l'ha ivitata, per questo devo pagare io per tutto."
      "E finché è una mia ospite devo farlo per lei. Mi giro verso Monika."
      mc "Monika... Pago io per tutto."
      m 1bg "[player], no! Dividiamo il conto, così è giusto."
      mc "No, pago io."
      python:
        m_aff -= 1
      $ renpy.sound.play(audio.notif)
      $ renpy.notify("Affetto di Monika = \"[m_aff]\"")
      "Monika, sembra un po' triste, rimette i suoi soldi nel borsellino, lasciandomi pagare il conto."
      mc "Puoi aspettare la--"
      m 2bh "Mhm."
      show monika at rhide
      hide monika
      "Poi si incammina verso un tavolo e si siede."
      "..."
      n "{i}Hey.{/i}"
      mc "{i}Hm?{/i}"
      n "{i}Penso avresti dovuto lasciar pagare la tua ragazza metà del conto{/i}"
      mc "{i}Non è ancora la mia ragazza.{/i}"
      n "{i}Ceeeeeeeeertooo... Non lo è...{/i}"
      "Poi si dirige verso la cucina per preparare i nostri ordini. Potrei aver sbagliato ora che ci penso..."
      "Ma lasciarle pagare il conto avrebbe potuto rovinare la mia reputazione come uomo."
    else:
      "Penso che chiederò a Monika di dividere il conto... Non è giusto se paga tutto lei, no?"
      "Visto che l'ho invitata, sarebbe una buna idea se facessimo così."
      "Monika mi sta ancora guardando quindi le rispondo."
      mc "Monika, e se dividessimo il conto invece di pagare tutto tu?"
      m 1bc "Um..."
      extend 2bd " Sei sicuro?"
      mc "Certo! Penso che sarebbe ingiusto se pagassi tutto tu."
      mc "Non è un problema!"
      m 2bj "Okay."
      $ m_aff += 1
      $ renpy.sound.play(audio.notif)
      $ renpy.notify("Affetto di Monika = \"[m_aff]\"")
      "Prendo il mio portafoglio e allungo a Monika abbastanza soldi per coprire la mia metà del conto."
      m 3bb "Grazie~"
      show monika at rhide
      hide monika
      "Poi va a cercare un posto dove possiamo sederci."
      n "I vostri ordini saranno pronti tra poco."
      mc "Va bene."
      "Mi dirigo verso il tavolo che Monika ha scelto."
    scene black
    with wipeleft
    scene bg cafe_inside
    with wipeleft
    if m_aff > 0:
      "Monika felicemente mi fa cenno con la mano di sedermi."
      show monika 1bb at t11 zorder 1
      m "[player]~"
      mc "Eccomi."
      m "Mhm~"
      m 1bd "Hey, [player]?"
      mc "Sì?"
      m 1be "Volevo solo ringraziarti per aver pagato metà del conto!~ E' stato davvero carino da parte tua."
      mc "Oh! Certo, ho pensato che sarebbe stato sbagliato se avessi lasciato pagare tutto a te."
      m 2bk "Ahaha!~"
    else:
      "Monika è seduta al tavolo che sta fissando il vuoto attraverso la finestra."
      show monika 1bc at t11 zorder 1
      mc "Sono tornato."
      m 1bc "Mhm."
      "Monika, senza neanche guardarmi mi da una risposta secca."
      mc "Hm? E' successo qualcosa?"
      m 1bd "Sì."
      extend 3bg " Non pensi che avrei dovuto almeno pagare metà del conto?"
      mc "No, non preoccuparti. Va bene così."
      m 2bf "Okay..."
    mc "Quindi, c'è qualcos'altro di cui volevi parlarmi?"
    m 1bc "Hm..."
    if m_aff > 0:
     m 1bn "B-beh, volevo ringraziarti anche per tutto quello che hai fatto per me fino ad ora!"
    else:
     m 1bn "B-beh, volevo ringraziarti per tutto quello che hai fatto per me fino ad ora!"
    mc "Heh, beh non ho fatto tutto io, anche Kotonoha ha fatto la sua parte, ricorda."
    m "Sì... Hai ragione."
    m 2bn "E se andassimo a far visita a Kotonoha al suo hotel? Vorrei parlarle."
    mc "Certo, dovevo parlarle anche io."
    show monika 1bh at t11 zorder 1
    "Monika mi fissa mentre è persa nei suoi pensieri, poi comincia a parlare."
    m 2bi "E' successo qualcosa?"
    mc "Allora.. Oggi ha pianto di nuovo per colpa mia..."
    if persistent.kt_choice1 == 1:
     mc "Senza menzionare il suo strano comportamento di oggi."
    m 2bc "Hm..."
    m 2bd "Per quella csa di Natsuki?"
    mc "Già... Pensa che io la odi per aver detto a Natsuki che era stata lei a riportarti indietro."
    mc "Devo spiegarle tutto e farle sapere che non la odio. Penso che capirà."
    m 2be "E' un sollievo..."
    $ n_name = "Cameriere"
    n "Il vostro caffè è pronto!~"
    "Il cameriere arriva con un vassoio con sopra due tazze. Poi appoggia gentilmente sul tavolo entrambe le tazze e fa un inchino."
    mc "Wow, questo posto ha davvero un ottimo servizio."
    m 1ba "E' davvero un ottimo bar~"
    mc "Già, sembra porpio così."
    m 1bj "Mhm~"
    "Con questo Monika beve un sorso del suo caffè. Solo il profumo intenso che emana la sua tazza mi fa tornare bambino... Dovrei provare quel caffè."
    m 1ba "Quindi, [player]..."
    extend 2bb " Hai assegnato a tutti da fare delle poesie per l'incontro di domani, no?"
    mc "Già... Mi dispiace di aver preso il tuo posto. Sembravi un po' giù in quel momento."
    m "Ahaha!~ Va bene [player], grazie per averlo fatto per me!"
    mc "In più penso sia un ottimo modo per ricosturire il club e conoscere un po' meglio Mio."
    m 1bf "Già, Mio..."
    mc "Hm?"
    m 2bl "Oh! Non importa, ignoralo."
    "Mentre guarda fuori dalla finestra, Monika beve un altro sorso dalla sua tazza."
    mc "E' successo qualcosa con Mio?"
    m "No, è tutto apposto [player]..."
    mc "Hm..."
    $ mi_name = "???"
    mi "[player]? Monika?"
    $ n_name = "Natsuki"
    ...
    mc "Uhhh... Mio? Che ci fai qui?"
    mi "E' successo qualcosa? Sembra quasi che vi abbia spaventato un fantasma ragazzi!"
    "..."
    "Quando è entrata Mio? Non l'ho neanche vista."
    "Monika abbassa lo sguardo appena vede che Mio è qui, quindi credo di dover essere io a chiedere cosa ci faccia qui."
    mc "Non hai ancora risposto alla mia domanda Mio."
    mi "Hm..."
    extend 1e "Volevo comprare un caffè per me presumo. E' una caffetteria dopotutto, no Monika?"
    m 2bp "G-già..."
    mc "Non dovresti scrivere la poesia per domani?"
    mi 2e "Sì, per questo prendo il caffè~ Scrivere una poesia non è l'unico compito che ho da fare."
    mi 1e "Passo spesso del tempo a fare i compiti e a studiare di notte. Quindi le verifiche a sorpresa non mi sorprendono!"
    mc "Giusto. Quindi, va via e fai quello che devi fare."
    mi 3h "Eeehhh? Ma il mio caffè non è ancora pronto! Il caffè è qualcosa che richiede del tempo, giusto Monika?"
    m 1bp "G-giusto."
    mc "Beh... Cioè, interrompere un'altra conversazione non è educato."
    mi 1f "Oh! Stai parlando di qualcuno dietro di noi? Perchè davvero brutto, [player]... Potresti ferire i loro sentimenti!"
    mi 8f "Forunatamente, la parte generosa di me lascerà correre, però la prossima volta te la farò pagare~"
    mc "Finché non si parla di soldi, sono favorevole a fare qualsiasi cosa tu voglia."
    mi 8e "Qualsiasi cosa io voglia? "
    extend 1y "Uhuhu~ "
    extend 3e "Questo è lo spirito, [player]!"
    mc "No, non intendo in quel senso! Intendevo che--"
    mi 1a "Troppo tardi per i rimpianti [player], ora dovrai mantenere quella promessa."
    mi 2x "Non vedo l'ora di sapere di cosa parlate di me mentre non sono in giro!"
    $ n_name = "Commesso"
    n "{i}Ordine caffè Espresso!~ La sua bevanda è pronta!{/i}"
    $ n_name = "Natsuki"
    mi 3e "Oh, eccomi! Ci vediamo domani ragazzi~"
    mc "Uh-huh. Ci vediamo."
    mi 8e "Ci vediamo Monika!"
    m "C-certo. Ciao."
    "Con quello, Mio si incammina verso il commesso, prende il suo caffè, e lascia il bar, facendopmi l'occhiolino mentre se ne va."
    show mio at thide
    hide mio
    ...
    "..."
    mc "Cosa?"
    m 1bd "Senti... Quando sono entrata in classe, Mio mi ha salutato in modo davvero strano, quasi come se sapesse cos'ho fatto."
    mc "Beh, chiaramente si comporta un po' altezzosamente, ma ad essere sinceri penso sia solo com'è fatta lei."
    m 2bq "..."
    m 2br "Cioè, si comporta così solo con me [player], ma non lo fa con gli altri."
    "Non so dove Monika lo abbia tirato fuori... Ma non ci vedo niente di sbagliato in lei, in realtà."
    "Ho solo detto che è una persona un po' altezzosa, tutto qui. A meno ché non abbia mostrato di essere ben consapevole di cos'è questo mondo veramente."
    "Allora sarebbe qualcosa di cui anche Kotonoha dovrebbe preoccuparsi, ma per ora queste sono solo speculazioni di Monika."
    "Diamole il beneficio del dubbio."
    mc "{i}*sigh*{/i}"
    mc "Senti Monika... Quello che stai dicendo è a malapena dimostrabile, senza dire che non può essere provato. Per ora queste sono solo tue supposizioni."
    m 1bg "Ma [player]--"
    mc "Ciò nonostante, se questo ti può far sentire meglio allora diamole il beneficio del dubbio e teniamola d'occhio."
    m 1bd "Non dovremmo dirlo a Kotonoha di questo?"
    mc "No, non ancora. Se confermeremo che sa qualcosa allora lo diremo a Kotonoha."
    mc "Capito?"
    m 2bd "Sì... Penso sia la scelta migliore per ora."
    $ renpy.music.play(audio.city, channel="music", fadein=2.0, tight=True)
    mc "Bene, allora divertiamoci prima di andare da Kotonoha."
    m 1bb "Mhm~"
    scene black with wipeleft
    scene bg park_c with wipeleft
    "Ci siamo seduti su una panchina del parco, guardando gli alberi che sono coperti di dalla fioca luce solare che lentamente inizia ad affievolirsi in notte."
    "Monika - nonostante il fatto che è ancora preoccupata, in verità si sta divertendo."
    "SI sta facendo già buio quindi penso che sia il momento per mettere fine a questo giorno."
    mc "Hey Monika, è ora di andare."
    mc "Dormi a casa tua stanotte o cosa?" 
    show monika 2bl at t11 zorder 1
    m "Beh... Non è che abbia una casa mia, sai?"
    mc "Allora puoi dormire a casa mia, ti va bene?"
    m 1bk "Okay [player]!"
    mc "Immagino tu abbia le tue cose dentro a quel borsello, vero?"
    m 1ba "Sì!"
    mc "Va bene, allora... Andiamo da Kotonoha? Così possiamo scrivere le poesie per domani."
    m 2bk "Ahaha!~"
    extend 2bb " Hai portato il tuo quaderno?"
    mc "Dannazione... No, l'ho dimenticato... ALlora potremmo andare un'altra volta a casa sua."
    m 3bb "Posso darti una pagina del mio quaderno se vuoi!"
    mc "Oh, faresti questo per me?"
    m 3bk "Certo! In più, casa tua è lontanissima da qui. Ahaha!~"
    mc "Heh, è vero. Andiamo allora."
    m "Mhm~"
    "Detto questo, Monika ed io ci incamminiamo verso l'hotel di Kotonoha."
    scene black with wipeleft
    scene bg city_c with wipeleft
    m "Hey, [player]..."
    mc "Hm?"
    "Monika alza il suo sguardo e mi fissa."
    show monika 2bp at t11 zorder 1
    m "E' davvero per me questo?"
    mc "Uh? Di che cosa stai parlando?"
    stop music fadeout 2.0
    m 1bn "Hai detto a Mio che avresti fatto qualsiasi cosa lei volesse..."
    mc "Uhm... Beh, non sapevo cosa dire..."
    mc "Ma se sei così preoccupata allora sì, non lo faccio solo per te; è anche per tutti gli altri."
    mc "Mio era... Beh, è stato un mio errore portarla al club... Quindi, per ora dobbiamo provare ad andarci d'accordo."
    m 2bn "Già... Credo tu abbia ragione."
    mc "Mhm. "
